# -*- coding: utf-8 -*-
"""
Created on Mon Jun  6 16:20:10 2016
...
df1n = df[((df['openp']!=df['lowp'])&(df['closep']==df['lowp'])&(df['plimit']==-1))|
          ((df['openp']!=df['lowp'])&(df['closep']!=df['lowp'])&(df['plimit']==-1))|
          ((df['openp']!=df['lowp'])&(df['closep']==df['lowp'])&(df['plimit']!=-1))|
          ((df['openp']!=df['lowp'])&(df['closep']!=df['lowp'])&(df['plimit']!=-1))|
          ((df['openp']==df['lowp'])&(df['closep']!=df['lowp'])&(df['plimit']==-1))|
          ((df['openp']==df['lowp'])&(df['closep']!=df['lowp'])&(df['plimit']!=-1))|
...
df1 = df[(df['openp']==df['lowp']) & (df['closep']==df['lowp']) & (df['plimit']==-1)]
...
df33nnn = df33[(df33['magn']<0)&(df33['magn-1']<0)&(df33['magn-2']<0)]
