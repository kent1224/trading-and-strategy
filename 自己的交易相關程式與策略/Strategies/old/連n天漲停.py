# -*- coding: utf-8 -*-
"""
Created on Mon Aug  7 18:52:00 2017
...
sql = sql + " where [日期]>='20150701' and len([股票代號])=4 and left([股票代號],1)<>0"
...
df1 = df[(df['ss']==df['ss1b'])&(df['ss']==df['ss1a'])&(df['h']>df['l'])&(df['ml']==1)]
df1 = df1[(df1['ml1b']!=1)]#&(df1['ml2b']==1)
df1 = df1.reset_index()

df2 = df1[(df1['c1b']>=10)&(df1['v1b']>=300)&(df1['o']==df1['c'])]#
...
#df2['m1a1'] = df2['m1a']-0.5-1.5
df3['m1a1'] = ((df3['m1a']-0.6)*2/3)-1

print(df3['m1a1'].sum())

df4 = df3.groupby('ym')['m1a1'].sum().reset_index()
